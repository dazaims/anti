...
game.DescendantAdded:Connect(function(k)
	...
	if k:IsA("Attachment") 
	if k:IsA("Part") or k:IsA('Folder') then return end
	if k.Name == 'OriginalPosition' or k.Name == 'OriginalSize' or k.Name == 'AvatarPartScaleType' or k.Name == 'Rocks' then return end
